...
define config.name = _("Crystal Lake Championship Wrestling")
...
define build.name = "CrystalLakeChampionshipWrestling"
...
define config.save_directory = "CrystalLakeChampionshipWrestling-1539471893"
